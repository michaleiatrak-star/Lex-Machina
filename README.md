...
[![Wersja stabilna](https://img.shields.io/badge/stabilna-24.09.2026-2A6F50.svg)](#-wersjonowanie)
...
**Obie wersje — stabilna (24.09.2026) i rozwojowa — są w pełni wieloplatformowe.**
...
> (`Wersja stabilna rozpakowana 24.09.2026/`) — obie niosą warstwę
...
|---|---|---|
| Adapter runtime | [`shared/UNIVERSAL-RUNTIME-ADAPTER.md`](Wersja%20stabilna%20rozpakowana%2024.09.2026/shared/UNIVERSAL-RUNTIME-ADAPTER.md) | Jeden kontrakt wykonawczy: mapuje operacje zależne od hosta (`view`, `web_search`, `web_fetch`, `create_file`, `show_widget`) na natywne funkcje hosta lub ich odpowiedniki. |
...
├── WERSJA STABILNA 24.09.2026/               ← skille spakowane (.zip) — wersja stabilna
├── WERSJA ROZWOJOWA/                        ← skille spakowane (.zip) — wersja rozwojowa
├── Wersja stabilna rozpakowana 24.09.2026/   ← źródła skilli — wersja stabilna
...
>
> **Inne hosty:** host-neutralne są **obie wersje — stabilna (24.09.2026) i rozwojowa**
...
Host-neutralna jest zarówno wersja stabilna (24.09.2026), jak i rozwojowa, więc
...
2. **Wskaż wersję** — którą gałąź/katalog ma wziąć:
   ...
   |---|---|---|
   | 🟢 stabilna (zalecana) | `Wersja stabilna rozpakowana 24.09.2026/` | tak |
...
|---|---|---|
| 🟢 **Stabilna** | `WERSJA STABILNA 24.09.2026/` + katalog rozpakowany | do codziennej pracy; **wieloplatformowa** — Claude + ChatGPT/Codex/API/Atlas + Grok |
