# Moduł — Odpowiedzialność podmiotów zbiorowych za czyny zabronione
...
## ⚡ ALERT — PLANOWANA DUŻA REFORMA (projekt, status: weryfikuj online)

```
Od ok. 2022 r. w pracach rządowych znajduje się PROJEKT NOWEJ USTAWY o
odpowiedzialności podmiotów zbiorowych (kompleksowa nowelizacja, ODRĘBNA od
Dz.U. 2025 poz. 1440). Status na 2026-06-14: w wykazie prac legislacyjnych
rządu — WERYFIKUJ aktualny etap (projekt / I czytanie / uchwalona / wygaszona)
przed każdym powołaniem.

Kluczowe planowane zmiany (jeśli uchwalona):
  → Wyeliminowanie wymogu wcześniejszego prawomocnego skazania osoby fizycznej
    (prejudykat) jako warunku odpowiedzialności podmiotu zbiorowego
  → Odpowiedzialność za KAŻDE przestępstwo popełnione na korzyść podmiotu
    (obecnie: zamknięty katalog z art. 16)
  → 10-letni okres przedawnienia
  → Rozszerzony katalog sankcji: zakaz reklamy, zakaz dotacji/zamówień
    publicznych, przepadek, rozwiązanie/likwidacja podmiotu
  → Obowiązki compliance dla średnich/dużych przedsiębiorców (system
    informowania o nieprawidłowościach / ochrona sygnalistów)

web_search: "projekt ustawy odpowiedzialność podmiotów zbiorowych 2026 status prac sejm"
web_search: "ustawa odpowiedzialność podmiotów zbiorowych nowelizacja uchwalona 2026"
```

---

## Zakres
Odpowiedzialność karna osób prawnych (spółek, fundacji, stowarzyszeń) za przestępstwa
popełnione przez: osobę fizyczną działającą w imieniu lub interesie podmiotu, organ,
prokurenta, pełnomocnika lub pracownika — jeśli podmiot odniósł korzyść.

Warunek (stan obecny, Dz.U. 2024 poz. 1822): wcześniejsze prawomocne skazanie sprawcy
...
poniżej) — sprawdź aktualny status projektu przed udzieleniem odpowiedzi o
warunkach odpowiedzialności.

## Kary
```
Kara pieniężna (art. 7):     1 000 zł – 5 000 000 zł, nie więcej niż 3% przychodu
                              osiągniętego w roku obrotowym czynu zabronionego
                              ✅ VER online 2026-06-14

Kara pieniężna — art. 7a:    odrębna podstawa wymiaru (przypadek z art. 4a) —
                              WERYFIKUJ aktualne brzmienie i przedział kwotowy
                              w ISAP przed powołaniem (nie cytować z pamięci)

Przepadek (art. 8):          korzyści, przedmiotów pochodzących z czynu,
                              lub ich równowartości — obligatoryjny w niektórych
                              przypadkach (wyjątek: zwrot uprawnionemu podmiotowi)
...
Zatarcie:                     z mocy prawa po 10 latach od wykonania/darowania/
                              przedawnienia wykonania kary pieniężnej, przepadku,
                              zakazów oraz podania wyroku do publicznej wiadomości
```
