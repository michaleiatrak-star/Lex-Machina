...
Dla pogłębionej analizy, INTAKE, map postępowań, kalkulatorów i predykcji → wczytaj pełny framework:

```
view /mnt/skills/user/prawny-router-v3/references/prawo-rodo.md
```

Framework zawiera: FAZA 0 (INTAKE), mapy postępowań, katalogi roszczeń/instrumentów,
predykcję wyniku z szablonami, BENCHMARKING orzeczniczy, kalkulatory terminów.
