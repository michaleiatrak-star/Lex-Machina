...
- Ustawa o KW i hipotece: **Dz.U.2023.1984**
...
| Ustawa o KW i hipotece | Dz.U.2023.1984 | Art. 5 (rękojmia wiary publ. KW) |
...
```
view /mnt/skills/user/prawny-router-v3/references/prawo-nieruchomosci.md
```

Zawiera: due diligence nieruchomości (4 działy KW, EGIB, miejscowy plan),
umowę deweloperską (12 przypadków odstąpienia, MRP, DFG, roszczenia nabywcy),
rękojmię (wady fizyczne i prawne — termin 5 lat od wydania/stwierdzenia wady),
wspólnotę mieszkaniową (uchwały, zarząd, windykacja zaległości),
najem (umowa, wypowiedzenie, ochrona lokatora, eksmisja + wyjątki od zakazu zimowego),
zasiedzenie (20/30 lat + ograniczenia dla nieruchomości rolnych),
służebności.
