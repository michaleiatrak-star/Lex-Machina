...
description: |
  ...
  v3.1: KROK 0 — wczytanie kontekstu z analizator-dowodow-v3 KROK 4a lub
  z pliku kontekstu sesji (MOD-KONTEKST-SESJI TRYB IMPORT); auto-zasilenie
  W1 intake, W3 pytań (bloki B/D/E) i chronologii do loopingu.
dependencies:
  required:
    - shared
    - analizator-dowodow
