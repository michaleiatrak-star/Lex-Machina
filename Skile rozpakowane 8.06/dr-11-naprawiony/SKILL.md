...
description: |
  ...
  Weryfikacja: isap.sejm.gov.pl | eur-lex.europa.eu | uodo.gov.pl | sn.pl
---
...
## Moduły (21 łącznie — ✓ 20 OK, ☐ 1 STUB [certyfikacja])

```
DANE OSOBOWE:
  [✓] OK    mod-RODO-GDPR-2016-679
              (RODO Rozp. 2016/679 — zakres, podstawy przetwarzania, prawa podmiotów)
  [✓] OK    mod-RODO-framework
              (framework roboczy: intake, mapa zagadnień, tabela decyzyjna)
...
WŁASNOŚĆ INTELEKTUALNA I IP:
  ...
  [✓] OK    mod-PrAut-framework-IP
              (framework roboczy IP: intake, tabela decyzyjna, predykcja)
