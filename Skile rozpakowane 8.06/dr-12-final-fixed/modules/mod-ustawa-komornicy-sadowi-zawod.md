...
- Uwaga: egzekucja komornicza jako TRYB → DR-03/mod-ustawa-komornicy-sadowi.
  Ten moduł = komornik jako ZAWÓD i organ (status, odpowiedzialność, wybór, OC).
---
...
| tryb egzekucji | DR-03/`mod-ustawa-komornicy-sadowi` |
