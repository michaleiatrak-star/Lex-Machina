      ...
      const friendly =
        code === "PROVIDER_NOT_CONFIGURED"
          ...
          : code === "PROVIDER_EXECUTION_FAILED"
            ...
            : code === "DETERMINISTIC_WORKFLOW_SKILL_INVALID"
              ? "Wybrany skill nie ma aktywnego kodowego workflow deterministycznego. Wybierz skill oznaczony jako deterministyczny albo wróć do AUTO."
