...
export class LocalAuthStore {
  ...
  getModelRoutingPreferences(
    ...
    if (
      ...
      throw new Error(
        "AUTH_DB_INVALID_MODEL_ROUTING_PROVIDER"
      );
    }
    ...
    if (
      ...
      throw new Error(
        "AUTH_DB_INVALID_MODEL_ROUTING_MODEL"
      );
    }
