...
describe(
  ...
  () => {
    ...
    it(
      "rejects a signed index whose release version does not match the discovered release before downloading the ZIP",
      async () => {
        const {
          maintenance,
          bundleFetch
    ...
    it(
      "rejects a signed index whose maximum app version is below the installed application before downloading the ZIP",
      async () => {
        const {
          maintenance,
          bundleFetch
