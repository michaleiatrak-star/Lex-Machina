...
const original =
  "Anna Nowak, PESEL 44051401458, e-mail anna.nowak@example.pl, tel. +48 600-700-800.";
...
const pseudonymizer =
  new LocalPolishPseudonymizer(vault, ner);

const result =
  await pseudonymizer.pseudonymize(original);
...
if (
  serializedVault.includes("Anna Nowak") ||
