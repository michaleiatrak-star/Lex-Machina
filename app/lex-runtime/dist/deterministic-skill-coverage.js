export const DETERMINISTIC_SKILL_COVERAGE = [
    {
        ...
        deterministicOwner: "router-first bootstrap, core gates, route/dependency validation, source/citation/finalization invariants",
        semanticOwner: "ambiguous intent/jurisdiction/domain classification and legal explanation"
    },
    {
        skill: "prawo-polskie-v2",
        status: "ENFORCED",
        migrationClass: "DETERMINISTIC_ROUTER_HYBRID",
        deterministicOwner: "DR allowlist, routing-map integrity, module/dependency resolution and route validation",
        semanticOwner: "ambiguous multi-domain classification"
    },
    {
        skill: "pisma-proste-v2",
        status: "ENFORCED",
        migrationClass: "STRUCTURED_OUTPUT_HYBRID",
        deterministicOwner: "resource reads, intake/output contract, escalation and final validation",
        semanticOwner: "fact narration and legal argument wording"
    },
    {
        skill: "pisma-procesowe-v3",
        status: "ENFORCED",
        migrationClass: "STATE_MACHINE_HYBRID",
        deterministicOwner: "durable per-case state, checkpoints, optimistic revision, permits, final status and validation",
        semanticOwner: "strategy, argumentation, counterargument and drafting"
    },
    {
        skill: "analiza-sadowa-v6",
        status: "ENFORCED",
        migrationClass: "STATE_MACHINE_HYBRID",
        deterministicOwner: "ordered passes/checkpoints, completeness, required reads and final report contract",
        semanticOwner: "legal qualification, adversarial interpretation and significance"
    },
    {
        skill: "analizator-dowodow-v3",
        status: "ENFORCED",
        migrationClass: "STATE_MACHINE_HYBRID",
        deterministicOwner: "encrypted per-case ordered state, checkpoint permits, required gates/resources, evidence inventory/provenance invariants and final output contract",
        semanticOwner: "evidentiary significance, hypotheses and conflict interpretation"
    },
    {
        skill: "analizator-przepisow-v2",
        status: "ENFORCED",
        migrationClass: "STRUCTURED_OUTPUT_HYBRID",
        deterministicOwner: "fresh source/resource gates, status/citation invariants and full-report structure",
        semanticOwner: "interpretation, conflicts of norms and practical meaning"
    },
    {
        skill: "analizator-umow-v1",
        status: "ENFORCED",
        migrationClass: "STATE_MACHINE_HYBRID",
        deterministicOwner: "mode/stage/checkpoint state, clause/checklist gates, report variants and finalization",
        semanticOwner: "semantic contract risk, negotiation strategy and clause wording"
    },
    {
        skill: "chronologia-sprawy-v1",
        status: "ENFORCED",
        migrationClass: "STATE_MACHINE_HYBRID",
        deterministicOwner: "ordered chronology state, provenance/date/conflict schema and temporal gates",
        semanticOwner: "meaning of events and legal consequences"
    },
    {
        skill: "orzeczenia-sadowe-v2",
        status: "ENFORCED",
        migrationClass: "STRUCTURED_OUTPUT_HYBRID",
        deterministicOwner: "source/status/citation gates, dedupe/provenance fields and full-report contract",
        semanticOwner: "similarity, ratio decidendi relevance and argumentative use"
    },
    {
        skill: "przesluchanie-swiadkow-v2-min90",
        status: "ENFORCED",
        migrationClass: "STATE_MACHINE_HYBRID",
        deterministicOwner: "encrypted per-case ordered state, checkpoint permits, required resources, admissibility/coverage invariants and output gates",
        semanticOwner: "question generation, adaptation and examination strategy"
    },
    {
        skill: "raport-klienta-v1",
        status: "ENFORCED",
        migrationClass: "STRUCTURED_OUTPUT_HYBRID",
        deterministicOwner: "required reads, structured report blueprint, source/numeric fields and finalization",
        semanticOwner: "plain-language explanation and option framing"
    },
    {
        skill: "raport-sytuacyjny-v2",
        status: "ENFORCED",
        migrationClass: "STRUCTURED_OUTPUT_HYBRID",
        deterministicOwner: "structured report blueprint, source/status fields, IO schema and finalization",
        semanticOwner: "narrative synthesis, risk explanation and prioritization"
    },
    {
        skill: "przewodnik-prawny-v2",
        status: "ENFORCED",
        migrationClass: "DETERMINISTIC_ROUTER_HYBRID",
        deterministicOwner: "target: session mode, one-question policy, intake state, irreversible-action warnings and route handoff",
        semanticOwner: "dialogue, intent interpretation and lay-language transformation"
    },
    {
        skill: "audyt-systemu-v4",
        status: "CODE_FIRST",
        migrationClass: "CODE_AUDIT",
        deterministicOwner: "structural/version/dependency/checksum/map/static checks and release gates",
        semanticOwner: "interpretation of substantive legal/methodological findings"
    },
    {
    ...
    },
    {
        ...
        deterministicOwner: "source hierarchy, citation ledger, attachment completeness, step tracker, domain/rate locks, provenance and fail-closed invariants",
        semanticOwner: "only policy explanations that cannot be expressed as executable predicates"
    }
];
export const DETERMINISTIC_EXECUTION_SKILLS = DETERMINISTIC_SKILL_COVERAGE
    .filter((entry) => [
    "ENFORCED",
    "PARTIAL",
    "CODE_FIRST"
...
export function validateDeterministicSkillCoverage(installedSkillNames) {
    ...
    const missingClassifications = [...installed]
        .filter((name) => !classified.has(name))
        .sort();
    const staleClassifications = [...classified]
        .filter((name) => !installed.has(name))
        .sort();
    return {
        result: missingClassifications.length === 0 &&
        ...
        duplicateClassifications: [...new Set(duplicateClassifications)].sort()
    };
}
