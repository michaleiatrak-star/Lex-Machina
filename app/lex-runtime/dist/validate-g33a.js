...
const exactProd = Object.values(runtime.dependencies ?? {})
    ...
    !/[~^*xX><=\s]/.test(value));
const exactPython = requirements.every((line) => /^[A-Za-z0-9_.-]+==[^=\s]+$/.test(line));
const sha256 = (value) => typeof value === "string" && /^[a-f0-9]{64}$/i.test(value);
const pinnedSources = source.schemaVersion === 4 &&
...
const sourceHashEnforced = bootstrap.includes("Get-VerifiedDownload") &&
...
const lockContract = generator.includes("sha256Manifest") &&
