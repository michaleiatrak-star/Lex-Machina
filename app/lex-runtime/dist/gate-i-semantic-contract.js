import { DETERMINISTIC_SKILL_COVERAGE } from "./deterministic-skill-coverage.js";
...
export function gateISemanticContract(skill) {
    const entry = coverage(skill);
    const responsibilities = CONTRACTS[skill];
    if (!entry ||
        !responsibilities ||
    ...
    return {
        ...
        semanticResponsibilities: responsibilities,
        forbiddenMechanicalResponsibilities: COMMON_FORBIDDEN
    };
}
export function gateISemanticPrompt(skill) {
