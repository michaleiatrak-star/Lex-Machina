import { LegalSourceVerificationError, OfficialLegalSourceVerifier } from "./legal-source-verifier.js";
const SOURCE_URL = "https://api.sejm.gov.pl/eli/acts/DU/1964/93/text.html";
...
async function runAttempt() {
    const verifier = new OfficialLegalSourceVerifier(fetchWithTimeout);
...
process.stdout.write(JSON.stringify({
    ...
    ...(result?.record.status === "UNVERIFIED"
        ? {
            verificationEvidence: result.record.evidence
        }
        : {}),
    ...
    ...(lastError && !result
        ? {
            error: lastError instanceof LegalSourceVerificationError
                ? lastError.code
