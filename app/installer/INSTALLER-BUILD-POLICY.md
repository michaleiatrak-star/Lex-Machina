...
- The app EXE, NSIS installer and uninstaller use only `src-tauri/icons/lex-machina-brand-source.jpg`. The source hash is pinned and `materialize-brand-icon.ps1` deterministically generates the multisize `icon.ico`.
