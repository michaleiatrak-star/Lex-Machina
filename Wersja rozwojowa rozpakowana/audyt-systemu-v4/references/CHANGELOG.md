...
- 6.126 (2026-09-23, AUDYT-2026-09-23c): FAZA 3E i TRYB DZU: źródła zastępcze przy BRAKU-AKTU w RZĘDZIE 1; PAMIEC-TRWALA-ROUTER: wzorzec preferencji („Zablokowane? — inna droga”); AUDIT-JOURNAL: wpis AUDYT-2026-09-23c.
- 6.125 (2026-09-23, AUDYT-2026-09-23b): FAZA 3E i TRYB DZU: kolejność źródeł wg kanonu E-1…E-5 (ELI pierwszy, ISAP link dla człowieka, 2A/2B dopiero po porażce ELI). FAZA 0D / pozycja 13 przeprojektowana: bez zapisu do pamięci trwałej hosta (klasyfikator odrzuca bloki dyrektyw), kontrola zgodności preferencji z UP routera, wzorzec preferencji bez numeru wersji.
- 6.124 (2026-09-23, przegląd rejestru): **AUDYT-2026-09-23 — przeniesienie flag zamkniętych z rejestru żywego do dziennika (ZASADA 10).** `WARN-OTWARTE.md` 665 → 384 linie: 25 bloków zamkniętych i wpisów nieaktualnych przeniesionych verbatim do `AUDIT-JOURNAL.md` (F-147, F-150/151, F-152, F-153/154, F-155, F-156, F-159, F-168, F-169, F-170, F-172, F-175–178, F-179, F-180, F-181, F-186a, F-190, F-OP-2026-09, O-4, O-5, O-6, O-7, O-9, O-10, O-11 oraz kandydat 2026-09-10j). Kontrola bajtowa: żadna linia oryginału nie zginęła. ⛔ Pięć usterek samego rejestru: (1) 14 bloków miało dopisek „do rejestru żywego nie wchodzą" i mimo to w nim było; (2) O-5/O-6/O-7 występowały równolegle jako ZAMKNIĘTE i OTWARTA; (3) F-156 wpisana dwukrotnie z różnymi liczbami przebiegu; (4) blok F-157b rozrywał tablicę sterującą na dwie tabele; (5) pięć niespójności rejestru zapisanych jako otwarte, bez nadania numerów F-. ⚠️ Operacja porządkowa — zasadności zamknięć NIE weryfikowano pomiarem.
- 6.123 (2026-09-22d, F-194/F-195): **AUDYT-2026-09-22d.** Drzewo robocze przełączone z kopii hosta na repozytorium (GitHub, kanał rozwojowy, commit 4194a1a z 18.09.2026): czerwone wyniki suity z sesji 22–22c były artefaktem nieaktualnej kopii hosta — na drzewie repozytorium suita PASS. F-195 ZAMKNIĘTA (router 3.53: osierocona kopia ISAP-METRYKI → odesłanie). F-194 zawężona do CBOSA (pisma-procesowe-v3 5.27: ETAP 4A V10).
- 6.122 (2026-09-22c, F-195): **AUDYT-2026-09-22c.** Ordynacja podatkowa KROK 2C (RZĄD 1 ELI, references aktu bazowego + art. końcowe): sześć nowelizacji po t.j. 2026/622, w tym trzy nieśledzone w systemie (875, 1098, 1206) — mapa (4 wiersze główne + MONITORING), ROUTING-MAP, dr-06 3.90. Przykład FAZY 3D oznaczony jako historyczny. F-195 zawężona do kopii routera (zablokowana regresją T12). Wydanie: prawo-polskie-v2 6.29, dr-06 3.90, audyt-systemu-v4 6.122.
- 6.121 (2026-09-22b, F-194/F-195): **AUDYT-2026-09-22b.** F-195: MONITORING mapy przejrzany w całości przez artykuły końcowe (RZĄD 1 ELI) — 8 wierszy usuniętych (w mocy / nieogłoszony / podmiana aktu 2025/1390 / zdublowany zamknięty), 2026/516 i 2026/1123 uzupełnione, OP ⬛; tabela główna: 5 wierszy poprawionych. F-194: Zasada 2B w orzeczenia-sadowe-v2 2.18; V10 zablokowane regresją dyskową pisma-procesowe-v3. Wydanie wg ZASADY 7: prawo-polskie-v2 6.28, shared 3.79, orzeczenia-sadowe-v2 2.18, audyt-systemu-v4 6.121.
- 6.120 (2026-09-22, F-193/F-194/F-195): **AUDYT-2026-09-22 — L4 (Dz.U. 2026 poz. 26) i NSA I OSK 590/26.** Nowa generacja `mapa_dzu_2026-09-22.md` (wiersz 2026/26 z czterema etapami; MONITORING: 1.10.2026 i 1.01.2027). F-193 zamknięta w sesji (dr-04 3.38, prawo-polskie-v2 6.27, shared 3.78). WARN-OTWARTE: nowe F-194 (wpięcie reguł do V10 + odczyt CBOSA), F-195 (FAZA 3D — wiersze przeterminowane). Wydanie wg ZASADY 7: 4 osobne paczki.
