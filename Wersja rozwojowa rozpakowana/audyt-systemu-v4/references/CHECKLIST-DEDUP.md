...
| OSP — status prawny (stowarzyszenie, nie sąd/służba szczególna) + PSP/ochrona przeciwpożarowa/OSP jako akty BEZ modułu | `shared/ORZECZENIA-HIERARCHIA.md` §4.3 (status prawny) + `dr-13/MAPA-AKTOW.md` (Dz.U. skatalogowane, moduły brak — ❌ otwarte) | dr-13 | ⚠️ CZĘŚCIOWE — Dz.U. skatalogowane 2026-07-06, moduły merytoryczne NIE napisane, wymaga sesji dedykowanej |
