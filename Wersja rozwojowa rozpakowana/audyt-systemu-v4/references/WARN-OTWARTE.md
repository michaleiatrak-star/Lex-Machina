...
**Stan na 2026-08-20k:** WARN numerowanych otwartych: **0** (WARN-1…WARN-29
zamknięte). Flag F- otwartych: **24** — w tym **20 wykonalnych sesją audytową**
...
| F-89 | niski (pozostałość po wyczerpującej sesji) | cross (16 DR) | **SESJA 2026-08-18/19: wynik T11 71→32 pozycji (55% redukcja).** ~16 pozycji bezpośrednio naprawionych + duży efekt uboczny (pełne łańcuchy nowelizacji wpisywane przy okazji innych flag rozwiązały dodatkowe pozycje uboczne). Naprawy w: dr-01, dr-02, dr-04, dr-05, dr-06, dr-09, dr-13, dr-15. Metoda potwierdzona skuteczna: `--kierunek lokalne --limit 0`, weryfikacja indywidualna, false-positive świadomie odsiewane (5 w dr-06). Odkryto 2 kierunki desynchronizacji (centralna-w-tyle: większość; lokalna wewnętrznie niespójna: 1 przypadek dr-01). Pozostaje 32 pozycje, w większości starsze (2019-2024) o niższym ryzyku praktycznym — priorytet "ostatnie 12 miesięcy" z definicji flagi w dużej mierze wyczerpany. Dalsza praca ma malejący zwrot; kontynuacja możliwa w kolejnej sesji bez presji czasowej. |
| F-88 | średni-wysoki | cross (7 DR) | ✅ MDR, VAT, opłata skarbowa, PIT/CIT, KKS zamknięte (patrz AUDIT-JOURNAL dla historii). **Sesja 19w-19y:** adwokatura/radcowie (RZĄD 1 potwierdzony), Prawo bankowe (hipoteza automatycznego zwolnienia MDR ODRZUCONA), SKOK/ubezpieczenia (hipoteza średniej pewności, nieprzypisana do artykułu) — `mod-OP-ordynacja-podatkowa.md` sekcja 6b. **Sesja 20d:** PPSA — CZĘŚCIOWO dotknięty: doprecyzowanie terminu skargi na opinię transgraniczną (Dz.U. 2026.846, w życie 1.10.2026) zapisane w `mod-PPSA-terminy-kasacja-prawo-pomocy.md` sekcja 7; ⚠️ [NIEWERYFIKOWANE RZĄD 1] — dokładny artykuł nieznany; pozostała treść nowelizacji PPSA z tej ustawy NIE zbadana, mogła być szersza niż ten jeden punkt. **Pozostaje w całości nieopracowane:** fundusze inwestycyjne, instrumenty finansowe (poszukiwania sesji 20d nie trafiły na treść zmian poz. 846 dla tych ustaw — jedyne znalezione zmiany funduszy/instrumentów pochodzą z INNEJ, odrębnej ustawy o osobistych kontach inwestycyjnych z 3.07.2026, MYLIĆ NIE). **Ograniczenie narzędziowe:** web_fetch na isap.sejm.gov.pl/api.sejm.gov.pl/dziennikustaw.gov.pl zablokowany w tym środowisku (ROBOTS_DISALLOWED) — dalszy postęp wymaga źródeł pochodnych z pełnym numerem artykułu lub F-8/F-10 (connector deweloperski) |
