...
| F-12 | SPH-B (`pisma-proste-v2/references/SPH-inne.md`) — zaskarżalność odmowy przywrócenia terminu procesowego pozostaje sporna w doktrynie/orzecznictwie; poprzedni cytat art. 394 §1 pkt 2 KPC był błędny (ten punkt dotyczy zwrotu pozwu) i został usunięty, ale nie zastąpiony pewnym ustaleniem | pisma-proste-v2 | średni | 2026-07-25 | Ustalono, że katalog art. 394 §1 KPC nie wymienia wprost odmowy przywrócenia terminu; zaskarżalność zależy od tego, czy in concreto stanowi postanowienie "kończące postępowanie w sprawie" — kwestia sporna. Sekcja oznaczona [NIEWERYFIKOWANE — SPORNE] z instrukcją web_search przy każdym użyciu | Przy najbliższej aktywnej sprawie z tym wnioskiem: web_search "zażalenie odmowa przywrócenia terminu KPC orzecznictwo [rok]", ustalić zarówno dopuszczalność jak i adresata (sąd II instancji vs. inny skład tego samego sądu) dla konkretnego typu uchybionej czynności, i dopiero wtedy zamknąć flagę z twardym ustaleniem w SPH-inne.md |
...
| F-14 | Projekt ustawy Ministerstwa Infrastruktury ws. odblokowania hulajnóg/rowerów elektrycznych — na dzień otwarcia flagi NADAL projekt, nie uchwalona ustawa | dr-03-prawo-karne-wykroczenia-egzekucja (`mod-przerobki-modyfikacje-pojazdow.md`, sekcja 1) | niski | 2026-08-04 | Projekt (kierownictwo MI: Dariusz Klimczak) z lipca 2026 — kary administracyjne dla sprzedawców/importerów odblokowanych hulajnóg, nadzór TDT nad rynkiem, uprawnienia Straży Miejskiej do kontroli mocy/prędkości na drodze, obowiązek parkowania hulajnóg współdzielonych w wyznaczonych miejscach. ODRĘBNIE już potwierdzone jako OBOWIĄZUJĄCE (nie część tej flagi): limity 20/25 km/h (od 2021), kaski do 16 lat i wiek min. 13 lat (od 03.06.2026) | web_search "ustawa hulajnogi elektryczne odblokowanie 2026 Sejm uchwalił status" — jeśli STAŁA SIĘ ustawą: przenieść treść z "projekt" na "obowiązujące prawo" w module docelowym z datą uchwalenia/wejścia w życie, zamknąć tę flagę (wpis w AUDIT-JOURNAL.md); jeśli NADAL projekt: zaktualizować datę weryfikacji tutaj; jeśli upadła: oznaczyć jako nieaktualną w module, zamknąć flagę |
