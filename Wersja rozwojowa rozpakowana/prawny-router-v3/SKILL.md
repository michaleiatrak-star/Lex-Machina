...
changelog:
  - '3.42 (2026-09-09, F-169): historia przeniesiona do lokalizacji kanonicznej. Pełne wpisy 3.30–3.41 usunięte z tego pola i przeniesione do references/CHANGELOG.md (wpisy 3.38–3.41 tam wcześniej NIE istniały) — standard systemowy 2026-08-20z4 zakazuje trzymania pełnej listy wpisów w YAML. Zamyka ⛔ LUKA HISTORII z T12 i mieści plik w budżecie lekkiego korpusu z T17. Zero zmian w treści proceduralnej, routingu [1]–[11], regułach i bramkach. Pełna historia: references/CHANGELOG.md.'
---
