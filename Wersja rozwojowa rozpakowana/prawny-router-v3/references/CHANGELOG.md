...
- 3.55 (2026-09-23, AUDYT-2026-09-23c): Korekty użytkownika do 3.54: UP-2 i ZRODLA-AKTOW-FALLBACK — E-3/E-4 uruchamia BRAK-AKTU (akt niepobieralny z RZĘDU 1: awaria serwera, timeout, blokada) i wtedy jest obowiązkowe; przy awarii ELI próba odczytu z ISAP. „Zakaz obchodzenia blokad” zastąpiony ZASADĄ INNEJ DROGI (robots.txt nie przesądza; granice: logowanie, licencja, CAPTCHA, zabezpieczenia). HARD-GATES-ORZECZNICTWO analogicznie. SELF-CHECK: OC-1 — skala 0–10 dozwolona; E-3/E-3b wg BRAKU-AKTU.
- 3.54 (2026-09-23, AUDYT-2026-09-23b): UP-2 = kanon E-1…E-5 (ELI pierwszy; ISAP adres dla człowieka; LEX/Legalis → ArsLege po porażce ELI w obu kanałach). ZRODLA-AKTOW-FALLBACK przepisany na E-1…E-5 + zakaz obchodzenia blokad. KROK 3: R-3.54-a (DR-xx przed weryfikacją), R-3.54-b (wezwanie czytane przed routingiem). HARD-GATES-ORZECZNICTWO: standard potwierdzenia istnienia (jeden rekord; zakaz „prawdopodobnie istnieje”). KROK0A: ścieżka FOLDER/DYSK (anonimizacja skryptem przed odczytem), forma bezosobowa. SELF-CHECK: blok OC (zakaz ocen liczbowych) i blok E (kolejność źródeł). Instrukcje „weryfikuj w ISAP” w legacy → ELI.
