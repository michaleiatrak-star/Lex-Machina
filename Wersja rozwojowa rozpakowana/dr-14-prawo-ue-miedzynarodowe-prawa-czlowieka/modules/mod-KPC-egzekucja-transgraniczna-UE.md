# Moduł — Egzekucja transgraniczna UE i procedury europejskie (KPC-UE)


## 1. Akty i źródła do weryfikacji
- TFUE/TUE i rozporządzenia UE właściwe dla sprawy
- KPC w sprawach transgranicznych
- ustawy implementujące prawo UE
...
- pomoc publiczna
- skargi do KE
- wykonanie prawa UE przez organ krajowy
...
Rozporządzenia UE — egzekucja i procedury transgraniczne:
  Bruksela Ia 1215/2012 — jurysdykcja i uznawanie orzeczeń cywilnych i handlowych
    (stosowane od 10.01.2015; znosi exequatur w UE)
  Bruksela IIb 2019/1111 — sprawy małżeńskie i władza rodzicielska
    (stosowane od 01.08.2022)
  Rzym I 593/2008 — prawo właściwe dla zobowiązań umownych
  Rzym II 864/2007 — prawo właściwe dla zobowiązań pozaumownych
  ENZ 1896/2006 — europejski nakaz zapłaty
  ESCP 861/2007 — europejskie postępowanie w sprawie drobnych roszczeń
    (do 5 000 EUR bez kosztów i odsetek; formularz online)
  Rozp. 1393/2007 (zmienione 2020/1784) — doręczenia zagraniczne
...
Kluczowe procedury:
  Uznanie orzeczenia zagranicznego: art. 1145–1149 KPC
  Stwierdzenie wykonalności (exequatur): art. 1150–1153 KPC — zbędne dla Bruksela Ia
  Europejski nakaz zapłaty (ENZ): wniosek do SR, formularz A, sprzeciw → umorzenie ENZ
  Doręczenie za granicą: Rozp. 2020/1784 (e-doręczenia od 01.07.2022)
  Apostille / legalizacja: Konwencja haska 1961 — weryfikuj przy każdym dokumencie

⚠️ Bruksela Ia znosi exequatur — orzeczenie sądu UE wykonalne w Polsce bez dodatkowego
   postępowania. Wyjątek: klauzula porządku publicznego (art. 45 Bruksela Ia).
```
