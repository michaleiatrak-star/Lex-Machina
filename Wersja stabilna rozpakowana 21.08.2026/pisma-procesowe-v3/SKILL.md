...
changelog: |
  Wersja bieżąca: 5.18. ⛔ PEŁNA HISTORIA — WYŁĄCZNIE w references/CHANGELOG.md
  ...
  Skrót 5.18 (2026-08-20z4): wpisy 5.12-5.18 przeniesione z korpusu SKILL.md do references/CHANGELOG.md —
  koniec rozbicia historii na dwa pliki, które w F-102 spowodowało fałszywy
  raport testu T12 o luce siedmiu wersji.
