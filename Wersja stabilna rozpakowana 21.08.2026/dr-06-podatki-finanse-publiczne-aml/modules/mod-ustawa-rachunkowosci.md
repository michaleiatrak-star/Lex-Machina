...
⭐⭐⭐ ZASADA KONTYNUACJI DZIAŁANIA (going concern) — ⭐ ROSNĄCE
  ...
  finansowe TEJ jednostki (patrz sekcja 4d — badanie PRZEZ
  biegłego rewidenta)
...
⭐⭐ WYMOGI MERYTORYCZNE (art. 22) — dowody księgowe POWINNY BYĆ:
  ...
  → ⚠️ NIEDOPUSZCZALNE: dokonywanie W dowodach WYMAZYWANIA i
    ...
    NIERZETELNEJ" z art. 53 §22 KKS (sekcja 5 tego modułu) —
...
⭐ WAŻNA WSKAZÓWKA METODOLOGICZNA: SAMA ustawa NIE ZAWIERA zasad
  ...
  Standardów Rachunkowości (patrz sekcja 2 tego modułu — możliwość
...
⭐⭐⭐ SANKCJE — ODRĘBNY PRZEPIS OD ART. 77 (sekcja 5 tego modułu):
